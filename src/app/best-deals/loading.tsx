export default function BestDealsLoading() {
  return (
    <main aria-busy="true" aria-label="Loading best deals">
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-2 gap-x-1 gap-y-4 px-4 py-10 sm:gap-x-5 sm:gap-y-8 sm:px-6 sm:py-14 md:grid-cols-3 lg:grid-cols-4 lg:px-8">
